...
export const UserManager: React.FC = () => {
  ...
  const getRoleBadge = (role: Role) => {
    switch(role) {
        case 'admin': return <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded text-xs font-bold uppercase">Admin</span>;
        case 'sec': return <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded text-xs font-bold uppercase">Secretaria</span>;
        default: return <span className="px-2 py-1 bg-slate-100 text-slate-700 rounded text-xs font-bold uppercase">Comum</span>;
    }
  };
  ...
  return (
    <div className="p-8 h-full overflow-y-auto">
      <header className="mb-8">
        ...
        <p className="text-slate-500">Cadastre usuários e defina permissões de acesso.</p>
      </header>
